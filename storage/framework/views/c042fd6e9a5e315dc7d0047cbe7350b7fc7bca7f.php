                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" class="confirm" href="<?php echo e(route('roles.delete',['id' => $role->id])); ?>">حذف</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a7med404/a7meD404/WD_WORK/WorkingFolder/work-on/school-system/Modules/User/Providers/../Resources/views/roles/index.blade.php ENDPATH**/ ?>