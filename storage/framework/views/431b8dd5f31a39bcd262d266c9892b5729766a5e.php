        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="table_id" class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                            <tr>
                                <td><?php echo e($AddCalendInfo->id); ?></td>
                                <td><?php echo e($AddCalendInfo->employee_id); ?></td>
                                <td><?php echo e($AddCalendInfo->date); ?></td>
                                <td><?php echo e($AddCalendInfo->type); ?></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('add-calend.edit',  ['id' => $AddCalendInfo->id])); ?>">تعديل</a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="#">طباعة</a></li>
                                            <form action="<?php echo e(route('add-calend.destroy',['id' => $AddCalendInfo->id])); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/projects/school-system_4/school-system/Modules/Employee/Providers/../Resources/views/employees/calends/show.blade.php ENDPATH**/ ?>