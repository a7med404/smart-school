...
<?php echo e(__('home/sidebar.all_parts')); ?>
...
<section class="content">
                ...
                <table id="table_id" class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($part->level->name); ?></td>
                            <td><?php echo e($part->classroom->name); ?></td>
                            <td><?php echo e($part->name); ?></td>
                            <td><?php echo e($part->max_student_number); ?></td>
                            <td><?php echo e($part->sort); ?></td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('parts.edit',  ['id' => $part->id])); ?>">تعديل</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#">طباعة</a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" class="confirm" href="<?php echo e(route('parts.delete',['id' => $part->id])); ?>">حذف</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
    ...
    <!-- /.box -->
    <?php echo $__env->make('student::students.educations.parts.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>
<!-- /.content -->
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/projects/school-system_4/school-system/Modules/Student/Providers/../Resources/views/students/educations/parts/index.blade.php ENDPATH**/ ?>