                ...
                <div class="page-header">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-6 text-center invoice-col">
                            ...
                            <div class="m-t-30">
                            <strong class="report-title"> تقرير المراحل   </strong>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-3 invoice-col">
...
<?php echo $__env->make('student::layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a7med404/a7meD404/WD_WORK/WorkingFolder/work-on/school-system/Modules/Student/Providers/../Resources/views/print/report-levels/print-page.blade.php ENDPATH**/ ?>