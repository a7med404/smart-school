                                ...
                                <table class="table table-striped table-bordered table-hover full-width m-t-20" id="table_id">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td><?php echo e($departmentInfo->id); ?></td>
                                            <td><?php echo e($departmentInfo->managament_id); ?></td>
                                            <td><?php echo e($departmentInfo->name); ?></td>
                                          <td>
                                              <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                      <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('departments.show',  ['id' => $departmentInfo->id])); ?>"}}>استعراض</a></li>
                                                      <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('departments.edit',  ['id' => $departmentInfo->id])); ?>">تعديل</a></li>
                                                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">طباعة</a></li>
                                                      <form action="<?php echo e(route('departments.destroy',['id' => $departmentInfo->id])); ?>" method="post">
                                                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/projects/school-system_4/school-system/Modules/Employee/Providers/../Resources/views//employees/managaments/department/show.blade.php ENDPATH**/ ?>