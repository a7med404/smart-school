                    ...
                    <thead>
                        ...
                        <tbody>
                                <tr class="text-center">
                                    <td><?php echo e($addholidayInfo->id); ?></td>
                                    <td><?php echo e($addholidayInfo->name); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('add-holidays.show',  ['id' => $addholidayInfo->id])); ?>"}}>استعراض</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('add-holidays.edit',  ['id' => $addholidayInfo->id])); ?>">تعديل</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">طباعة</a></li>
                                                <form action="<?php echo e(route('add-holidays.destroy',['id' => $addholidayInfo->id])); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/projects/school-system_4/school-system/Modules/Employee/Providers/../Resources/views/employees/holiday/addholiday/show.blade.php ENDPATH**/ ?>