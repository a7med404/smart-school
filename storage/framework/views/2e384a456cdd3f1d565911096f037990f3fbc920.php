                ...
                <div class="page-header">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-6 text-center invoice-col">
                            ...
                            <div class="m-t-30">
                            <strong class="report-title"> تقرير ابناء العاملين  </strong>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-3 invoice-col">
            ...
            <table class="table table-striped table-bordered table-hover full-width m-t-20 m-20" id="table_id">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($object->religion); ?></td>
...
<?php echo $__env->make('student::layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/projects/school-system_4/school-system/Modules/Student/Providers/../Resources/views/print/report-emp-student/print-page.blade.php ENDPATH**/ ?>