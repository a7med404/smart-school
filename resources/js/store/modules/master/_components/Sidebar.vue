      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'add-student'}">
                    <i class="fa fa-circle-o"></i>اضافة طالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'all-students'}">
                    <i class="fa fa-circle-o"></i>الطلاب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'add-student-manual'}">
                    <i class="fa fa-circle-o"></i>اضافة طالب يدويا
                  </router-link>
                </li>
              </ul>
            </li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'attendance'}">
                    <i class="fa fa-circle-o"></i>تسجيل الاجازات و الغياب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'Attendancec-for-class'}">
                    <i class="fa fa-circle-o"></i> تسجيل لفصل
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'to-clinic'}">
                    <i class="fa fa-circle-o"></i>تحويل للمركز الطبي
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'record'}">
                    <i class="fa fa-circle-o"></i>شهادة قيد طالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'kindness'}">
                    <i class="fa fa-circle-o"></i>شهادة حسن سير و سلوك
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'permissiontodepart'}">
                    <i class="fa fa-circle-o"></i>اذونات الانصراف للطبة
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'completion'}">
                    <i class="fa fa-circle-o"></i>مخالصة بمصروفات طالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'student-transfer'}">
            ...
            <ul class="treeview-menu">
              <li><router-link :to="{name: 'education-levels'}"> <i class="fa fa-circle-o"></i>المراحل التعلمية</router-link></li>
              <li><router-link :to="{name: 'classrooms'}"> <i class="fa fa-circle-o"></i> الصفوف التعلمية</router-link></li>
            ...
            <ul class="treeview-menu">
              <li><router-link :to="{name: 'receipts'}"> <i class="fa fa-circle-o"></i>عرض مستلمي الطالب</router-link></li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <router-link :to="{name: 'add-student'}">
                    <i class="fa fa-circle-o"></i>تقرير غياب الطلاب
                  </router-link>
                </li>
              </ul>
            </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <router-link :to="{name: 'report-separate'}">
                <i class="fa fa-circle-o"></i> قرار فصل
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-warning'}">
                <i class="fa fa-circle-o"></i> انذار فصل
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-auth'}">
                <i class="fa fa-circle-o"></i> عرض بيانات دخول الموقع
              </router-link>
            </li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'report-school-register'}">
                    <i class="fa fa-circle-o"></i>السجل المدرسى
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-fee-completion'}">
                    <i class="fa fa-circle-o"></i>مخالصه بمصروفات طالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-kindness'}">
                    <i class="fa fa-circle-o"></i>تقرير شهادة حسن سير وسلوك
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-student-permission'}">
                    <i class="fa fa-circle-o"></i>تقرير انصراف الطلاب باذن
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-sudent-statement'}">
                    <i class="fa fa-circle-o"></i>تقرير حركة طالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-not-complate-data'}">
                    <i class="fa fa-circle-o"></i>طلاب لم تكتمل بياناتهم
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-student-absece'}">
                    <i class="fa fa-circle-o"></i>تقرير غياب الطلاب
                  </router-link>
                </li>
              </ul>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'pay-ruls'}">
                <i class="fa fa-circle-o"></i>بنود رسوم الطلاب
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'sms'}">
                <i class="fa fa-circle-o"></i> ارسال رسائل SMS للرسوم
              </router-link>
            </li>
            <li>
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'pay-classes'}">
                    <i class="fa fa-circle-o"></i>رسوم الصفوف
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'pay'}">
                    <i class="fa fa-circle-o"></i>دفع رسوم
                  </router-link>
                </li>
                <!-- <li><router-link :to="{name: 'settings'}"> <i class="fa fa-circle-o"></i>اعدادت الرسوم </router-link></li> -->
                <li>
                  <router-link :to="{name: 'registration'}">
                    <i class="fa fa-circle-o"></i>رسوم تسجيل الطالب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'recipt-settings'}">
                    <i class="fa fa-circle-o"></i>اعدادت الايصال
                  </router-link>
                </li>
              </ul>
            </li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'discount'}">
                    <i class="fa fa-circle-o"></i>تنزيل خصومات
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'discount-setting'}">
                    <i class="fa fa-circle-o"></i>اعدادات الخصومات
                  </router-link>
                </li>
              </ul>
            </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'add-student'}">
                <i class="fa fa-circle-o"></i> المدفوعات حسب المراحل
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'add-student'}">
                <i class="fa fa-circle-o"></i> مدفوعات الحافلة
              </router-link>
            </li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <router-link :to="{name: 'education-levels'}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'report-levels'}">
                <i class="fa fa-circle-o"></i> تقرير المراحل
              </router-link>
            </li>
            <!-- <li>
              <router-link :to="{name: 'report-classrooms'}">
                <i class="fa fa-circle-o"></i> تقرير قائمة الفصول
              </router-link>
            </li> -->
            <li>
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'report-data-classrooms'}">
                    <i class="fa fa-circle-o"></i>تقرير كل بيانات الصف
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'report-parts'}">
                    <i class="fa fa-circle-o"></i>تقرير الفصول
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-without-part'}">
                    <i class="fa fa-circle-o"></i>تقرير الطلاب بدون فصول
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'report-count-parts'}">
                    <i class="fa fa-circle-o"></i> عدد الفصول بكل المراحل
                  </router-link>
                </li>
              </ul>
            </li>
        ...
        <ul class="treeview-menu">
          <li><router-link :to="{name: 'add-student'}"> <i class="fa fa-circle-o"></i>توزيع الطلاب على الفصول</router-link></li>
          <li><router-link :to="{name: 'add-student'}"> <i class="fa fa-circle-o"></i>توزيع الطلاب على المستويات</router-link></li>
          <li><router-link :to="{name: 'add-student'}"> <i class="fa fa-circle-o"></i>توزيع الطلاب على المقررات</router-link></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'calends'}">
                <i class="fa fa-circle-o"></i>لوائح المخالفات
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'add-calend'}">
                <i class="fa fa-circle-o"></i>اضافة مخالفةالى موظف
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'bear-in-mind'}">
                <i class="fa fa-circle-o"></i> لفت نظر
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'emp-absence'}">
                <i class="fa fa-circle-o"></i> تسجيل غياب الموظفين
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'cut-allowance'}">
                <i class="fa fa-circle-o"></i> خصومات او بدلات
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'emp-pull'}">
                <i class="fa fa-circle-o"></i> طلب اخلاء طرف
              </router-link>
            </li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'managaments'}">
                    <i class="fa fa-circle-o"></i>الهيكل الاداري
                  </router-link>
                </li>
              </ul>
            </li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'employees'}">
                    <i class="fa fa-circle-o"></i>الموظفين
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'add-employee'}">
                    <i class="fa fa-circle-o"></i>اضافة موظف جديد
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'add-student'}">
                    <i class="fa fa-circle-o"></i> البيانات الوظيفية
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              <router-link :to="{name: 'agreements'}">
                <i class="fa fa-circle-o"></i>اقرارات
              </router-link>
            </li>
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'emp-setting-perissions'}">
                    <i class="fa fa-circle-o"></i> اعدادات الآذونات
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'emp-perissions'}">
                    <i class="fa fa-circle-o"></i> اذونات الموظفين
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'emp-holiday'}">
                    <i class="fa fa-circle-o"></i> طلب اجازة
                  </router-link>
                </li>
                <!-- <li><router-link :to="{name: 'emp-holiday-list'}"> <i class="fa fa-circle-o"></i> طلبات الآجازات</router-link></li> -->
                <li>
                  <router-link :to="{name: 'formal-holiday'}">
                    <i class="fa fa-circle-o"></i> الإجازات الرسمية
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'add-holiday'}">
                    <i class="fa fa-circle-o"></i> اضافة اسم اجازاة
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'salary-details'}">
                    <i class="fa fa-circle-o"></i>اعتماد رواتب مفصل
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'rewards-punition'}">
                    <i class="fa fa-circle-o"></i>المكافآت والجزاءات
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'realliance-salary'}">
                    <i class="fa fa-circle-o"></i> اعتماد الرواتب
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'progenitor'}">
                    <i class="fa fa-circle-o"></i> سٌلف الموظفين
                  </router-link>
                </li>
                <!-- <li><router-link :to="{name: 'salary-statement'}"> <i class="fa fa-circle-o"></i> كشف الرواتب </router-link></li> -->
                <li>
                  <router-link :to="{name: 'overpayment'}">
                    <i class="fa fa-circle-o"></i> زيادة الرواتب الدورية لموظف
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'overpayment-division'}">
                    <i class="fa fa-circle-o"></i> زيادة الرواتب على الشرائح
                  </router-link>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                <li>
                  <router-link :to="{name: 'evaluation-item'}">
                    <i class="fa fa-circle-o"></i>عناصر تقييم الموظف
                  </router-link>
                </li>
                <li>
                  <router-link :to="{name: 'evaluation-emp'}">
                    <i class="fa fa-circle-o"></i> تقييم الموظف
                  </router-link>
                </li>
              </ul>
            </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'report-permission'}">
                <i class="fa fa-circle-o"></i>تقرير اذونات موظف
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-rewards-punition'}">
                <i class="fa fa-circle-o"></i>تقرير الخصومات والمكافأت
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-search'}">
                <i class="fa fa-circle-o"></i>بحث الموظفين
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-salary'}">
                <i class="fa fa-circle-o"></i>تقرير التعريف بالراتب
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-progenitor'}">
                <i class="fa fa-circle-o"></i>تقرير سلف الموظفين
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-absence'}">
                <i class="fa fa-circle-o"></i>تقرير غياب الموظفين
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'report-evaluation'}">
                <i class="fa fa-circle-o"></i>تقرير تقييم الموظفين
              </router-link>
            </li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'add-parent'}">
                <i class="fa fa-circle-o"></i>اضافة اولياء الامور
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'add-student'}">
                <i class="fa fa-circle-o"></i>اضافة اولياء الامور يدويا
              </router-link>
            </li>
          </ul>
        </li>
        ...
        <ul class="treeview-menu">
          <li><router-link :to="{name: 'add-student'}"> <i class="fa fa-circle-o"></i>قوائم الطلاب (بمعايير متنوعة). </router-link></li>
          <li><router-link :to="{name: 'add-student'}"> <i class="fa fa-circle-o"></i> تقارير الغياب / التأخر / الاستئذان </router-link></li>
          ...
          <ul class="treeview-menu">
            <li>
              <router-link :to="{name: 'vehicles'}">
                <i class="fa fa-circle-o"></i>إدارة بيانات الحافلات
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'vehicle-routes'}">
                <i class="fa fa-circle-o"></i>إدارة بيانات خطوط السير
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'stations'}">
                <i class="fa fa-circle-o"></i>إدارة المحطات
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'drivers'}">
                <i class="fa fa-circle-o"></i>مشرفي الحافلات وتوزيعهم
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'subscriptions'}">
                <i class="fa fa-circle-o"></i>تسجيل الطلاب في النقل
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'attendees'}">
                <i class="fa fa-circle-o"></i>تسجيل حضور و انصراف
              </router-link>
            </li>
            <li>
              <router-link :to="{name: 'vehicle-reports'}">
                <i class="fa fa-circle-o"></i>تقارير إدارة النقل
              </router-link>
            </li>
          </ul>
        </li>
