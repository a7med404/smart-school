        ...
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <a type="button" data-toggle="modal" data-target="#popup-add-evaluation" href="#" class="btn btn-sm btn-info pull-left">
              <i class="fa fa-plus"></i>  اضافة تقييم الموظفين 
            </a>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                ...
                <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" disabled placeholder="" value="10" type="text" v-model="evaluation_emp.degree">
                  </div>
                </div>   
                <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                  <div class="form-group">
                    <label class="control-label"> التاريخ </label>
                    <input class="form-control" placeholder="" type="text" v-model="evaluation_emp.date">
                  </div>
                </div> 
              </div>     
              <div class="row">
