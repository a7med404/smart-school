<template>
  <div>
              ...
              <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <table class="table table-striped table-bordered table-hover full-width m-t-20" id="table_id">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td><a href="#" class="">الحضور قبل بدء الطابور</a></td>
                        ...
                        <tr>
                            <td>2</td>
                            <td><a href="#" class="">تقييم اخلاقي</a></td>
                            <td><a href="#" class="">10</a></td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-default" href="#"><i class="fa fa-arrows-alt"></i></a>
    ...
    <!-- Popup  -->
    <div class="modal fade" id="popup-add-evaluation">
              ...
              <div class="row">
                <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="" type="text" name="name" v-model="evaluation_item.name">
                  </div>
                </div>
                <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                  <div class="form-group">
                    <label class="control-label"> درجة التقييم </label>
                    <input class="form-control" placeholder="" type="text" name="name" v-model="evaluation_item.degree">
                  </div>
                </div>
              </div>
