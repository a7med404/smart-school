        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('all-students') }}"><i class="fa fa-circle-o text-aqua"></i> الطلاب</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('pay_rules.index') }}"><i class="fa fa-circle-o text-aqua"></i> بنود رسوم الطلاب</a></li>
                ...
                <li>
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('pay') }}"><i class="fa fa-circle-o text-aqua"></i> دفع رسوم</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{ route('add-calend.index') }}"><i class="fa fa-circle-o text-aqua"></i> اضافة مخالفةالى موظف</a></li>
