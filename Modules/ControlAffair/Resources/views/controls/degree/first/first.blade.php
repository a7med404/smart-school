            ...
            <div class="row">
                <div class="col col-xs-4">
                    <div class="form-group">
                        ...
                        {!! Form::label('subject_id', 'الفصل', ['class' => 'control-label']) !!}
                        {!! Form::select('part_id', getSelect('parts'), null, ['id' => 'part_id', 'class' => "form-control select2 {{ $errors->has('part    _id') ? ' is-invalid' : '' }}", 'value' => "{{ old('part_id') }}", 'required']) !!}
                        ...
                        <BR><BR>
                        {!! Form::submit('بحث', ['class' => 'btn btn-primary', 'name' => 'submit']) !!}
                        {!! Form::close() !!}
