...
<section class="content-header">
    <h1>اضافة النسبة <small>  </small></h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">اضافة النسبة</h3>
            <div class="box-tools pull-right">
                ...
                <i class="fa fa-plus"></i> اضافة النسبة
                </a>
            </div>
        </div>
        <div class="box-body">
              ...
              {{-- <div class="no-print">
                    <div class="col-xs-12">
                    <a href="/student/student-reports/levels/printpage/printpage" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> طباعة</a>
                    <a type="button" href="/student/student-reports/levels" class="btn btn-success" style="margin-right: 5px;">
    ...
    <!-- /.box -->
    @include('controlaffair::controls.degree.estimate.add')
</section>
<!-- /.content -->
...
<script type="text/javascript">
    ...
    var lastIdx = null;
        ...
        var table = $('#data').DataTable({
            ...
            autoWidth: false,
            select: true,
            ajax: '{!! route("Estimate.dataTable") !!}',
            columns: [
                { data: 'id', name: 'id', "width": "10%"},
                { data: 'percent', name: 'percent', "width": "20%" },
                { data: 'degree', name: 'degree', "width": "15%" },
                { data: 'class_id', name: 'class_id', "width": "15%" },
                { data: 'lessdegree', name: 'lessdegree', "width": "15%" },
