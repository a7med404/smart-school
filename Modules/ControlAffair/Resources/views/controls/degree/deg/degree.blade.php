...
<section class="content-header">
    <h1>الفترة الاولى <small>  </small></h1>
    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col col-xs-4">
                    <div class="form-group">
                        ...
                        {!! Form::input('subject_id', getSelect('subjects'), null, ['id' => 'subject_id', 'class' => "form-control select2 {{ $errors->has('subject_id') ? ' is-invalid' : '' }}", 'value' => "{{ old('subject_id') }}", 'required']) !!}
