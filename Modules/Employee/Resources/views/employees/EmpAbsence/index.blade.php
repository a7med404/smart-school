...
<script type="text/javascript">
    ...
    var lastIdx = null;
        ...
        var table = $('#data').DataTable({
            ...
            autoWidth: false,
            select: true,
            ajax: '{!! route("emp-absences.dataTable") !!}',
            columns: [
                { data: 'id', name: 'id', "width": "10%"},
                { data: 'employee_id', name: 'employee_id', "width": "20%" },
                { data: 'absence_from', name: 'absence_from', "width": "20%" },
                { data: 'absence_to', name: 'absence_to', "width": "15%" },
                { data: 'absence_reason', name: 'absence_reason', "width": "15%" },
