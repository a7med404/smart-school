...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> {{ __('home/sidebar.edit_payrul') }} {{ $certificateInfo->name }} </li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    {!! Form::model($certificateInfo, ['route' => ['certificates.update', $certificateInfo->id], 'method' => "PUT"]) !!}
                    @include('employee::employees.employee.certificates.form')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
