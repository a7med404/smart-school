...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> {{ __('home/sidebar.addcalend') }} {{ $evaluationItemInfo->name }} </li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    {!! Form::model($evaluationItemInfo, ['route' => ['evaluation-items.update', $evaluationItemInfo->id], 'method' => "PATCH"]) !!}
