...
class EvaluationItemController extends Controller
{
    ...
    {
        $id =  EvaluationItem::create($request->all())->id;
        return response()->json([
            'message' => 'تم الحفظ بنجاح',
            'EvaluationItem_id' => $id
        ], 201);
    }
    ...
    {
        return new EvaluationItemResource(EvaluationItem::findOrfail($id));
    ...
    {
        EvaluationItem::findOrfail($id)->update($request->all());
        return response()->json([
