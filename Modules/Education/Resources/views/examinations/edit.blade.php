...
<section class="content-header">
    <h1>{{ __('home/sidebar.all_examinations') }} <small>it all starts here</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('\cpanel') }}"><i class="fa fa-dashboard"></i> {{ __('home/sidebar.HOME') }} </a></li>
        <li><a href="{{ url('\cpanel\examinations') }}"><i class="fa fa-dashboard"></i> {{ __('home/sidebar.all_examinations') }} </a></li>
