...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ __('home/sidebar.edit_testimonial') }}</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    {!! Form::model($testimonialInfo, ['route' => ['testimonials.update', $testimonialInfo->id], 'method' => "PATCH"]) !!}
                    @include('setting::testimonials.form')
                    {!! Form::close() !!}
                </div>
            </div>
