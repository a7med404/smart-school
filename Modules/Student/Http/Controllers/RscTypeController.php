...
use Modules\Student\Entities\RscType;
use Modules\Student\Http\Requests\CreateRscTypeRequest;
...
class RscTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('student::students.account.rsc-types.index', ['rscTypes' => $rscTypes]);
    }
    ...
    public function show($id)
    {
        ...
        return view('student::students.account.rsc-types.show', ['rscTypeInfo' => $rscTypeInfo]);
    }
    ...
    {
        $rscTypeInfo = rscType::findOrFail($id);
        return view('student::students.account.rsc-types.edit', ['rscTypeInfo' => $rscTypeInfo]);
    }
    /**
