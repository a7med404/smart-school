...
use Modules\Student\Entities\DiscountSettingParent;
use Modules\Student\Transformers\DiscountSettingParentResource;
use Modules\Student\Http\Requests\CreateDiscountSettingParentRequest;
