    ...
    <div class="invoice-padding">
        ...
        <div class="row">
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div>
                    <h3 class="text-center"><strong> قرار فصل  </strong></h3>
                    <p class="m-b-20">السيد الاستاذ / ولي امر الطالب {{ $reportSeparateInfo->student->name }}</p>
                    <h3 class="m-b-20 text-center"><strong class="m-b-20"> تحية طيبة و بعد....  </strong></h3>
                    <p class="bold">قرر المدرسة فصل نجلكم........ ابتدا من اليوم  <span class="float-left"> {{ $reportSeparateInfo->from }} حتي {{ $reportSeparateInfo->to }}<span></p>
