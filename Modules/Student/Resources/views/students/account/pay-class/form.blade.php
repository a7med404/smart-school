<div class="row">
    ...
    <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="form-group">
            {!! Form::label('sort', 'اسم الصف', ['class' => 'control-label']) !!}
...
<div class="row">
    <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="form-group">
            {!! Form::label('head_master', ' انواع الرسوم', ['class' => 'control-label']) !!}
    ...
    <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
        <div class="form-group">
            {!! Form::label('school_master', 'اجباري', ['class' => 'control-label']) !!}
