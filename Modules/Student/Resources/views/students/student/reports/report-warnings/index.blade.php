...
<section class="content">
        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                <a type="button" data-toggle="modal" data-target="#popup-add-report-warning" href="#" class="btn btn-sm btn-info pull-left">
                    <i class="fa fa-plus"></i> اضافة انذار فصل
                </a>
            </div>
        </div>
        <div class="box-body">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('report-warnings.show',  ['id' => $object->id]) }}">طباعة</a></li>
    ...
    @include('student::students.student.reports.report-warnings.add')
