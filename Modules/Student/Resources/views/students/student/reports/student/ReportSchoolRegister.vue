<template>
  <div>
    <section class="content-header">
      <h1>تقرير السجل المدرسى  <small>  </small></h1>
      <ol class="breadcrumb">
        <li><a href="#">شوؤن تعليمية</a></li>
        <li class="active">تقرير السجل المدرسى </li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">تقرير السجل المدرسى </h3>
        ...
        <div class="box-body">
          <form role="form">
            ...
            <!-- Print Buttons -->
              <div class="no-print">
                  <div class="col-xs-12">
                  <a href="/student/print-page/report-school-register" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> طباعة</a>
                  <a type="button" href="/student/print-page/report-school-register" class="btn btn-success" style="margin-right: 5px;">
                      <i class="fa fa-download"></i> انشاء ملف PDF
                  </a>
                  <a href="/student/print-page/report-school-register" class="btn btn-primary"><i class="fa fa-pdf-card"></i> ملف PDF </a>
                  </div>
              </div>
              <!-- End Prints buttons -->
          </form>
