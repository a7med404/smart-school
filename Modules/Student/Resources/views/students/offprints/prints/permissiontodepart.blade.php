...
@section('content')
            ...
            {{-- <small class="">{{ now() }}</small> --}}
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-6 text-center invoice-col">
                        ...
                        <strong class="report-title">  اذونات الانصراف للطبة </strong>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-3 invoice-col">
    ...
    <div class="row">
        <div class="col col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 ">
            اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة  طالب اذونات الانصراف للطبة اذونات الانصراف للطبة  طالب اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة اذونات الانصراف للطبة
        </div>
    </div>
    <!-- /.row -->
